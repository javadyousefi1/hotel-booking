...
const Page = () => {
    return (<div className=" h-[calc(100dvh-0px)] bg-black ">
        <div className="container mx-auto pt-32">
            ...
            <Image src="/assets/images/landing.png" width={800} height={200} className="object-cover object-center !w-full mt-4 h-[80dvh]" quality={100} alt="sweet home" />
        </div>
